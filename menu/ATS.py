...
def main():
    ...
    <div style="text-align: center; padding: 0 10px 20px 10px;">
        <h1 style="margin-bottom: 10px; font-size: 2.5rem; font-weight: 700;">Applicant Tracking System</h1>
        <div style="background-color: rgba(70, 130, 180, 0.1); padding: 10px; border-radius: 8px; display: inline-block; margin: 0 auto;">
            <span style="font-size: 1.1rem; font-weight: 500; color: #4682B4;">
                Smart Resume Analysis & Optimization Tool
            </span>
        </div>
    </div>
